...
<div>
    <div align="justify">
        <p>Meu nome é Ramon, sou um <strong>Desenvolvedor e estudante de Ciência da Computação</strong> apaixonado por tecnologia e inovação. 
        Sempre em busca de crescimento contínuo, gosto de resolver problemas, criar soluções e explorar novos desafios por meio da programação.</p>
    </div>
    <div align="justify">
        <p>Atualmente atuo como <strong>Software Engineering Intern no Bradesco</strong>, trabalhando em ambiente corporativo com foco em <strong>Backend e Mainframe</strong>, utilizando tecnologias como <strong>Java, COBOL, Angular e TypeScript</strong>. É uma oportunidade que está impulsionando minha evolução profissional, ampliando meu contato com sistemas de grande escala e alta complexidade.</p>
    </div>
    <div align="justify">
        <p>Sou formado nos programas <strong>Oracle Next Education (ONE)</strong> e <strong>IBM Full Stack Software Developer</strong>, que consolidaram minha base em desenvolvimento, arquitetura de software, nuvem, bancos de dados, DevOps e aplicações modernas em diferentes stacks.</p>
    </div>
    <div align="justify">
        <p>Estou sempre construindo projetos, estudando novas ferramentas e buscando formas de evoluir. Se você também gosta de tecnologia, inovação e boas ideias, vamos nos conectar! 🚀</p>
    </div>
</div>
...
<div align="justify">
<p>Minhas principais competências técnicas incluem:</p>
</div>
...
<div align="center">
    ...
    <img src="https://img.shields.io/badge/COBOL-00427E?style=for-the-badge&logoColor=white"/>
